...
const sources = [
  ['kaykit-adventurers-free-2.0', 'https://kaylousberg.itch.io/kaykit-adventurers', '2.0', 'adventurers-free-2.0.zip'],
  ['kaykit-skeletons-free-1.1', 'https://kaylousberg.itch.io/kaykit-skeletons', '1.1', 'skeletons-free-1.1.zip'],
  ['kaykit-character-animations-free-1.1', 'https://kaylousberg.itch.io/kaykit-character-animations', '1.1', 'character-animations-free-1.1.zip'],
];

async function record([sourceId, officialUrl, advertisedVersion, archiveName]) {
